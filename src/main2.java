...
public class main2 {
    ...
    public void testAdminRole() throws IOException {
        ...
        admin.addEmployee("EMP-001", "Ahmed", "ahmed@email.com", "123 Street Cairo", "0123456789");
        admin.addEmployee("EMP-002", "Mohamed", "mohamed@email.com", "456 Boulevard Giza", "0198765432");
        admin.addEmployee("EMP-003", "Mariam", "mariam@email.com", "789 Avenue Alexandria", "0145678923");
        admin.addEmployee("EMP-004", "Hossam", "hossam@email.com", "101 Lane Luxor", "0132165498");
        admin.addEmployee("EMP-005", "Nour", "nour@email.com", "202 Drive Aswan", "0165432178");
